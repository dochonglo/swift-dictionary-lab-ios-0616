...
var stateAndCapitalDictionary = ["New York" : "Albany",
                                 "Ohio" : "Columbus",
                                 "Florida" : "Tallahassee",
                                 "Georgia" : "Atlanta",
                                 "Kentucky" : "Frankfort"]
...
// We created a dictionary with String keys and String values.
...
var capital = "Capital"
stateAndCapitalDictionary["Florida"] = capital
...
if let capitalOfFlorida = stateAndCapitalDictionary["Florida"] {
    print("The capital of Florida is \(capitalOfFlorida)")
}
...
stateAndCapitalDictionary["Pennsylvannia"] = anotherCapital
 ...
 */
// write your code here
if let capitalOfPennsylvannia = stateAndCapitalDictionary["Pennsylvannia"] {
 ...
 */
// write your code here
stateAndCapitalDictionary["Pennsylvannia"] = "Harrisburg"
 ...
 */
// write your code here
stateAndCapitalDictionary.removeValueForKey("Pennsylvannia")
print("\(stateAndCapitalDictionary)")
...
if let capitalOfNewYork = stateAndCapitalDictionary[state] {
 ...
 */
// write your code here
var bandAndMembers = ["Nirvana": ["Kurt Cobain", "Krist Novoselic", "Dave Grohl"],
                      "The Beatles" : ["John Lennon", "George Harrison", "Paul McCartney", "Ringo Starr"],
                      "The Breeders" : ["Kim Deal", "Kelley Deal", "Josephine Wiggs", "Jim Macpherson"],
                      "Pixies" : ["Frank Black", "Joey Santiago", "Kim Deal", "David Lovering"]]
...
// This dictionary has Strings has its Keys, and an array of Strings as its value.
...
if let membersOfPixies = bandAndMembers[bandName] {
